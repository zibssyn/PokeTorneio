        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFinalizado = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeveBye = table.Column<bool>(type: "INTEGER", nullable: false),
                    ResultadosMelhorDe3 = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Jogador1Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Jogador2Id = table.Column<Guid>(type: "TEXT", nullable: true),
                    ResultadoMelhorDe3 = table.Column<int>(type: "INTEGER", nullable: true),
                    Resultado = table.Column<int>(type: "INTEGER", nullable: true),
                    VencedorId = table.Column<Guid>(type: "TEXT", nullable: true),
                    TorneioId = table.Column<int>(type: "INTEGER", nullable: false),
